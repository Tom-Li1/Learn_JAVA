...
public class AverageScoreTimer {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < persons.length; i++) {
            persons[i] = UUID.randomUUID().toString().substring(0, 4);
        }
        ...
        */
        ...
        System.out.println("Finish in " + (endTime-startTime)/1000 + " seconds.");
    }
}